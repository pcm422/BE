...
# DB 세션 의존성과 현재 사용자 인증 함수 import (기존에 정의된 get_db_session, read_current_user 사용)
from app.core.db import get_db_session
# 현재 사용자 인증 의존성 함수 - 기존의 read_current_user를 사용 (예시: app/domains/users/router.py에서 정의)
from app.domains.users.router import read_current_user
from app.models import User  # User 모델 import

# favorites에서 정의한 스키마와 서비스 함수를 import 합니다.
from .schemas import FavoriteCreate, FavoriteRead
from .service import create_favorite, delete_favorite, list_favorites
